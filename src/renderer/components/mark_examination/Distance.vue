    ...
    export default {
        ...
        methods: {
            drawCanvas() {
                ...
                let finishScore = schoolInfo.getCirculateHandle();
                let roughScore = schoolInfo.getCirculateUntreated();
                //配置柱状图
                Highcharts.chart('DistanceCanvas',
                    {
                        chart: {
                            type: 'column',
