<template>
    <!--考察知识点得分率占比-->
    <div class="knowledge-point-score base-box">
        <pubTitle :req_title="req_title">
        </pubTitle>
        <div id="KnowledgePointScoreCanvas"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            Highcharts.chart('KnowledgePointScoreCanvas',
                {
                    chart: {
                        type: 'column',
